...
export default async function JoinPage() {
  ...
  return (
    <AdjustPadding>
      ...
      <div className="flex w-full gap-x-6 h-screen">
        {/* left section */}
        <div className="w-1/2">
        ...
        <div className="w-1/2">
          <div className=" flex flex-col gap-y-5">
            <h2 className="font-semibold text-3xl text-stone-800 dark:text-stone-400 leading-normal">
            ...
            <ul className="list-none space-y-3 text-stone-700 dark:text-stone-300 font-semibold">
            ...
            <Separator className="w-full h-[2px] relative my-4">
              <p className="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 bg-white rounded-md dark:bg-inherit px-2">
